...
/***/ function(module, exports) {
	...
	var dsSalutation = dataSet.dsSalutation = jslet.data.createDataset('Salutation', salutationFldCfg, {keyField: 'code', codeField: 'code', nameField: 'name'});
	...
	window.dsCountry = jslet.data.createDataset('Country', countryFldCfg, {keyField: 'code', codeField: 'code', nameField: 'name'}); 
	...
	var dsContact = dataSet.dsContact= jslet.data.createDataset('Contact', contactFldCfg, {keyField: 'id'});
